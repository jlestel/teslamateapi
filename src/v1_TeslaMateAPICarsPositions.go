...
func TeslaMateAPICarsPositionsV1(c *gin.Context) {
	...
	if !validToken {
		TeslaMateAPIHandleOtherResponse(c, http.StatusUnauthorized, "TeslaMateAPICarsPositionsV1", gin.H{"error": errorMessage})
		return
	}
	...
	query := `
		...
		WHERE
		car_id = $1 AND date BETWEEN '2025-06-05T22:49:04.605Z' AND '2025-09-03T22:49:04.605Z' and ideal_battery_range_km is not null
		GROUP BY 1
		ORDER BY 1`
